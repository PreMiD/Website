  ...
  <div>
    <div class="dl-container">
      <div class="dl-container__intro">
        <h2 class="container__header on-desktop">
          <span class="header__step">1.</span> Download the application
        </h2>
      ...
      <div class="dl-container__cards waves-aligned on-desktop">
        <div
          v-bind:key="platform"
          v-for="(platform, index) of platform_order"
        ...
        >
          <div v-bind:class="{ 'current_platform': index == 1 }" class="cards__card clickable">
            ...
            <div class="card__content">
              ...
              >You need to build an application for this OS on your own!</p>
            </div>
          </div>
        </div>
      </div>
