  ...
  <div>
    ...
    <div class="promo-container">
      ...
      <div class="promo-container__presences">
        <div data-aos="sliding-down" class="discord-usercard" v-for="presence of presences_display" v-bind:key="presence.service"
          :v-if="presence.profile.name !== ''">
          <div class="usercard__header">
            <div class="header__avatar" :style="'background-image: url(' + presence.profile.image + ');'"></div>
            ...
            <div class="activity__info">
              ...
              <div class="info__game">
                <div class="game__icon">
                  <img class="game" alt="./../assets/images/logo-big.svg" :src="presence.service_logo"
                ...
                <div class="game__content">
                  ...
                  <div class="game__time text-row">{{ $t(`home.examples.timestamp`, [presence.presence_time]) }}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container section-container section-container_reverse">
        <div data-aos="sliding-down" class="section-container__details">
          ...
          <ul>
            ...
            <li><p>Presence management.</p></li>
            <li><p>Sorting by category.</p></li>
          </ul>
        </div>
