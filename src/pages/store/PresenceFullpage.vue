        ...
        >
          <div class="header__title">
            ...
            <div
              ...
              :style="`background: linear-gradient(135deg, ${presenceData.color} 0%, black 100%);`"
            ></div>
          </div>
          <div class="header__buttons">
            <button
              v-if="!isInstalled && this.$root.extension_installed && typeof presenceData.button == 'undefined'"
...
export default {
  ...
  created() {
    ...
    axios(
      ...
      .finally(() => {
        var ReadmeFileName =
          Vue.$root.getI18nLanguage() == "en"
            ? "README"
            : "README_" + Vue.$root.getI18nLanguage();
        axios(
