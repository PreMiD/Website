          ...
          <div class="store-card__service">
            ...
            <div class="store-card__data">
              <transition name="route-animation" mode="out-in">
                <div v-show="!card_hovered" class="store-card__desc">
                  <p>{{ presence.description }}</p>
                </div>
              </transition>
              <transition name="route-animation" mode="out-in">
                <div v-if="this.$parent.extension_installed" v-show="card_hovered"
                  ...
                  <button v-if="isInstalled" class="button button_red" v-on:click="removePresence(presence.service)">
                    <span class="icon">
