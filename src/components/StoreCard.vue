<template>
    ...
    <div>
      <div class="store-card" @mouseover="card_hovered = true" @mouseleave="card_hovered = false" :style="
        ...
        <div class="store-card__service-info">
          <div class="store-card__service">
            ...
            <transition name="card-animation" mode="out-in">
              <div :key="presence.service + '_desc'" v-if="!card_hovered || !this.$root.extensionInstalled">
                <p class="store-card__desc">
                  {{ this.getPresenceDescription() }}
                </p>
              </div>
              <div :key="presence.service + '_buttons'" v-if="card_hovered && this.$root.extensionInstalled">
                <div v-if="
        ...
        <div class="store-card__gradient" :style="
