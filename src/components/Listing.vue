  ...
  <div class="presence-container__item">
    <div class="store-card" @mouseover="card_hovered = true" @mouseleave="card_hovered = false"
        ...
        <div class="store-card__service">
          <h2>
            <router-link :key="presenceLinkName" :to="`/store/${presenceLinkName}`">{{ presence.service }}
              <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"
                :title="`${$t('store.cards.verified')}.`" v-tippy class="store-card__verified"
          ...
          <transition name="card-animation" mode="out-in">
            ...
            <div key="buttons" v-if="card_hovered">
              <div v-if="this.$root.extension_installed && typeof presence.button == 'undefined'"
      ...
      <div class="store-card__gradient"
        :style="`background: linear-gradient(135deg, ${presence.color} 0%, rgba(0, 0, 0, 1) 100%);`"></div>
    </div>
  </div>
</template>
