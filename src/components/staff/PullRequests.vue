<template>
	<div class="staff-container">
		...
		{{ repo.full_name }}
		<div v-if="pReady">
			<div class="pullRequest" v-for="pullRequest in pullRequests" :key="pullRequest.id">
				<div class="user">
...
export default Vue.extend({
	...
	beforeMount() {
		// @ts-ignore
		this.$axios("https://api.github.com/orgs/PreMiD/repos").then(response => {
	...
	methods: {
		updatePullRequests() {
			...
			// @ts-ignore
			this.$axios(
				`https://api.github.com/repos/PreMiD/${this.repo}/pulls`
			).then((response: any) => {
