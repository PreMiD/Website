<template>
	<div class="legal-section">
		...
		<p>
			...
			full. Do not continue to use PreMiD's website if you do not accept all of
		...
		<p>
			...
			the Organization's terms of service. "The Organization", "Ourselves",
			"We", "Our" and "Us", refers to our Organization. "Party", "Parties", or
			...
			in the most appropriate manner, whether by formal meetings of a fixed
			duration, or any other means, for the express purpose of meeting the
			Client's needs in respect of provision of the Organization's stated
			services/products, in accordance with and subject to, prevailing law of
			Germany. Any use of the above terminology or other words in the singular,
			plural, capitalisation and/or he/she or they, are taken as interchangeable
			and therefore as referring to same.
		</p>
		<h2>Cookies</h2>
		<p>
			We employ the use of cookies. By using PreMiD's website you consent to the
			<a href="https://premid.app/cookies">use of cookies</a>
			in accordance with
			<a href="https://premid.app/privacy">PreMiD's privacy policy</a>.
		</p>
		<p>
		...
		<h2>License</h2>
		<p>
			Unless otherwise stated, PreMiD and/or it's licensors own the intellectual
			property rights for all material on PreMiD. All intellectual property
			rights are reserved. You may view and/or copy code from
			<a href="https://github.com/premid">PreMiD</a> for your own personal use
			subject to restrictions set in these terms of service.
		</p>
		<p>You must not:</p>
		<ol>
			<li>Sub-license material</li>
		</ol>
		<p>You have to:</p>
		<ol>
			<li>Make your source code open-source when you distribute something</li>
			<li>Copyright notice us</li>
			<li>
				Add the
				<b>same</b> license as we did
			</li>
		</ol>
		<p>
			Redistribute content from PreMiD (unless content is specifically made for
			redistribution).
		</p>
		<p>
			Our website is licensed under the MPL-2.0 license.
			<a href="https://opensource.org/licenses/MPL-2.0">Visit its page</a> for
			more information.
		</p>
		...
		<p>
			...
			associations or other organizations representing inherently suspect types
			of business, such as work-at-home opportunities, shall not be allowed to
			link); (b) the organization does not have an unsatisfactory record with
			us; (c) the benefit to us from the visibility associated with the
			hyperlink outweighs the absence of PreMiD; and (d) where the link is in
		...
		<p>
			...
			information so long as the link: (a) is not in any way misleading; (b)
			does not falsely imply sponsorship, endorsement or approval of the linking
			party and it products or services; and (c) fits within the context of the
			linking party's site.
		</p>
		<p>It may be hyperlinked to our website as follows:</p>
		<ol>
			...
			<li>
				By use of any other description of our website or material being linked
				to that makes sense within the context and format of content on the
				linking party's site.
			</li>
		</ol>
		<p>
			No use of PreMiD's logo or other artwork will be allowed for linking
		...
		<p>
			...
			that you remove all links or any particular link to our website. You agree
			to immediately remove all links to our website upon such request. We also
			reserve the right to amend these terms of service and its linking policy
			at any time. By continuing to link to our website, you agree to be bound
			to and abide by these linking terms of service.
		</p>
		<h2>Removal of links from our website</h2>
		<p>
			If you find any link on our website or any linked website objectionable
		...
		<p>
			...
			page on your website or within any context containing content or materials
