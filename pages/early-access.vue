		...
		<div class="max-w-6xl mx-auto">
			...
			<section class="grid mb-6 grid-cols-1 md:grid-cols-2 gap-8">
				<div class="p-6 shadow-lg rounded-lg flex flex-col justify-between bg-secondary">
					...
					<button class="bg-orange-500 rounded-full cursor-pointer hover:bg-orange-600 text-white py-3 px-4 b-solid b-none transition-colors text-nowrap w-min font-bold rounded" @click="openAlphaModal">
						Get Alpha Access
					</button>
				</div>
				...
				<div class="bg-secondary p-6 shadow-lg rounded-lg flex flex-col justify-between">
					...
					<div class="flex items-center gap-2">
						<button class="bg-green-500 cursor-pointer rounded-full text-white py-3 px-4 rounded b-solid b-none transition-colors text-nowrap w-min font-bold hover:bg-green-600" @click="openBetaModal">
							Sign Up for Beta
						</button>
