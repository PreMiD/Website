...
onMounted(async () => {
  ...
  const handleMouseMove = (e: MouseEvent) => {
    if (!scrollerMouseDown.value) return;
  ...
  <div>
    ...
    >
            ...
            <span class="relative flex text-center justify-center mx-2 w-25">
              <transition-group name="slide" tag="span">
                <span
                  ...
                  :key="word"
                  class="absolute left-0 w-25 font-bold text-gradient"
                  >{{ word }}</span
                >
              </transition-group>
            </span>
      ...
      >
        ...
        <div
          class="absolute top-0 left-0 bg-gradient-to-r h-full w-16 fade-left from-#111218 to-transparent"
        />
        <div
    ...
    <section class="mx5 py-12 bg-gray-100">
      <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:grid-cols-4">
          ...
          >
            <div
              class="bg-primary text-white rounded-full w-10 flex items-center justify-center mx-auto mb-4 absolute h-10 top--3 left--3"
            >
              {{ index + 1 }}
            </div>
            <div class="icon mb-4">
