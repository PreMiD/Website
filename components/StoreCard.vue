...
<template>
	<div
		class="relative select-none overflow-hidden cursor-pointer rounded-lg shadow-md w-20 w-90 h-40"
	...
	>
		...
		>
			...
			>
				<h1
					class="card-shadow font-bold text-ellipsis overflow-hidden text-xl text-nowrap"
					@click="goToPresence"
				>
			...
			<div
				class="text-color absolute flex gap-2 right-0 mr-2 flex-col op-50 shadow-tint mt-2"
			>
				<!-- <p>
