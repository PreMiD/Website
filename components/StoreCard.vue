	...
	>
		...
		>
			<NuxtImg
				...
				:alt="presence.metadata.service"
			/>
			<div class="relative my-a z-20 mr-4 text-color text-3 font-50 w-6/9 transition-color">
				<h1 class="card-shadow font-bold text-xl text-ellipsis text-nowrap overflow-hidden">
				...
				>
					<div :key="presence.metadata.service + '_desc'">
						<p
							v-if="!hovered"
							class="card-shadow line-clamp-2 line-height-3.5"
						>
			...
			<div class="text-color absolute right-0 flex gap-2 op-50 shadow-tint mt-2 mr-2 flex-col">
				<p>
